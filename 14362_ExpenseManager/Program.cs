...
builder.Services.AddDbContext<GeneralDBContext>(o => o.UseSqlServer(builder.Configuration.GetConnectionString("SqlServerConnection")));
builder.Services.AddScoped<IRepository<Expense>, ExpensesRepository>();
builder.Services.AddScoped<IRepository<ExpenseType>, ExpenseTypeRepository>();
